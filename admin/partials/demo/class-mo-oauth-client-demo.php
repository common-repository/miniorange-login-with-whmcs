			    ...
			    <!-- <div class="mo_table_layout mo_modal-demo"> -->
			    	...
			    	<table cellpadding="4" cellspacing="4">
			    		...
			    		<tr>
							...
							<td><input required type="email" style="<?php echo esc_attr( $democss ); ?>" name="mo_auto_create_demosite_email" placeholder="Email id" value="<?php echo esc_attr( get_option("mo_oauth_admin_email") ); ?>" /></td>
						</tr>
						<tr>
							...
							<td>
								<select required style="<?php echo esc_attr( $democss ); ?>" name="mo_auto_create_demosite_demo_plan" id="mo_oauth_client_demo_plan_id">
									...
									<option value="miniorange-oauth-client-standard-common@11.6.1">WP <?php echo esc_attr( MO_OAUTH_PLUGIN_NAME ); ?> Standard Plugin</option>
									<option value="mo-oauth-client-premium@21.5.3">WP <?php echo esc_attr( MO_OAUTH_PLUGIN_NAME ); ?> Premium Plugin</option>
									<option value="miniorange-oauth-client-enterprise@31.5.7">WP <?php echo esc_attr( MO_OAUTH_PLUGIN_NAME ); ?> Enterprise Plugin</option>
