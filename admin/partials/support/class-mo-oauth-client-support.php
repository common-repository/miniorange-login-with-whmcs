...
class Mo_OAuth_Client_Admin_Support {
	...
	?>
		<div id="mo_support_layout" class="mo_support_layout">
			<div>
				<h3>Contact Us</h3>
				<p>Need any help? Couldn't find an answer in <a href="https://faq.miniorange.com/kb/oauth-openid-connect" target="_blank" rel="noopener">FAQ</a>?<br>Just send us a query so we can help you.</p>
				<form method="post" action="">
					...
					<table class="mo_settings_table">
						...
						<tr>
							<td><input type="tel" id="contact_us_phone" pattern="[\+]\d{11,14}|[\+]\d{1,4}[\s]\d{9,10}|[\+]\d{1,4}[\s]" placeholder="Enter phone here" class="mo_table_textbox" name="mo_oauth_contact_us_phone" value="<?php echo esc_attr( get_option('mo_oauth_admin_phone') );?>"></td>
						</tr>
						<tr>
