<?php
 ...
 function customization_ui(){	
	...
	<form id="form-common" name="form-common" method="post" action="admin.php?page=mo_oauth_settings&tab=customization">
		...
		<a href="https://developers.miniorange.com/docs/oauth/wordpress/client/login-button-customization" target="_blank" rel="noopener">Click here</a> to know how this is useful. ]</span></div>
