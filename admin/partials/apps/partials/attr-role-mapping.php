		...
		<tr id="mo_oauth_email_attr_div">
				...
				<td>
					...
					if( is_array( $attr_name_list ) ) {  ?>
						...
						<input <?php if (get_option('mo_attr_option') === "manual" ) echo 'name="mo_oauth_username_attr"'; ?> class="mo_table_textbox" <?php if (get_option('mo_attr_option') === "automatic" || get_option('mo_attr_option') === false ) echo 'style="display:none"'; ?> placeholder="Enter attribute name for Username" type="text" id="mo_oauth_username_attr_input" value="<?php if( isset( $currentapp['username_attr'] ) )echo esc_attr( $currentapp['username_attr'] ); elseif( isset( $currentapp['email_attr'] ) )echo esc_attr( $currentapp['email_attr'] );?>">
						</td>
						...
						<td>
							<a href="#" id="mo_username_attr_change_p" onclick="changeFormField()"><?php echo esc_attr( $text_attr ); ?></a>
						</td>
						<?php
					} else { ?>
						<input class="mo_table_textbox" required="" placeholder="Enter attribute name for Username" type="text" id="mo_oauth_username_attr_input" name="mo_oauth_username_attr" value="<?php if( isset( $currentapp['username_attr'] ) )echo esc_attr( $currentapp['username_attr'] ); elseif( isset( $currentapp['email_attr'] ) )echo esc_attr( $currentapp['email_attr'] );?>">
						</td>
						<td>
						</td>
						<?php
