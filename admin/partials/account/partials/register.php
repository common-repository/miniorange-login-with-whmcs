...
function show_customer_info() {
	...
	<div class="mo_table_layout" >
		...
		<tr>
			...
			<td style="width:55%; padding: 10px;"><?php echo esc_attr( get_option( 'mo_oauth_admin_email' ) ); ?></td>
		</tr>
		<tr>
			<td style="width:45%; padding: 10px;">Customer ID</td>
			<td style="width:55%; padding: 10px;"><?php echo esc_attr( get_option( 'mo_oauth_admin_customer_key' ) );?></td>
		</tr>
		</table>
		<br /><br />
