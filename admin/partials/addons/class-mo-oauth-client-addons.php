...
class Mo_OAuth_Client_Admin_Addons {
  ...
  public static $all_addons = array(
        ...
        array(
          ...
          'img' => 'images/buddypress-logo.png',
...
<a  id="mobacktoaccountsetup_addon" style="display:none;" href="<?php echo esc_url( add_query_arg( array( 'tab' => 'account' ), htmlentities( $_SERVER['REQUEST_URI'] ) ) ); ?>">Back</a>
    ...
    ?>
      <div class="grid_view column_container" style="border-radius: 5px;">
        ...
        <div class="mo_float-child2">
          <div><strong><p style="font-size: 20px;margin: 1px;padding-left: 7px;line-height: 120%;font-weight: 600;font-family: Verdana, Arial, Helvetica, sans-serif;" ><a href= "<?php echo esc_url( isset($addon['link']) ? $addon['link'] : '' );?>" target="_blank" rel="noopener"><?php echo $addon['title'] ?></a></p></strong></div>
          </div>
        </div>
        <p style="text-align: center;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;"><?php echo esc_attr( $addon['desc'] );?></p>
        </div>
        </div>
      </div>
        <?php
